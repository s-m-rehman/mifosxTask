...
public class CommandWrapper {
	...
	public boolean isClientEntityDetails() {
		return this.entityName.equalsIgnoreCase("CLIENTENTITYDETAILS");
	}

	public boolean isCreateClientEntityDetails() {
		return this.entityName.equalsIgnoreCase("CLIENTENTITYDETAILS") && actionName.equalsIgnoreCase("CREATE");
	}
