...
public class DocumentCommandValidator {
    ...
    public void validateForCreate() {
        ...
        baseDataValidator.reset().parameter("registeredName").value(this.command.getName()).notBlank().notExceedingLengthOf(250);
        ...
        baseDataValidator.reset().parameter("tradingName").value(this.command.getName()).notExceedingLengthOf(250);
        baseDataValidator.reset().parameter("dateOfIncorporation").value(this.command.getName()).notExceedingLengthOf(250);
